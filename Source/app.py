...
class Master(Frame):
    def __init__(self,master=None):
        ...
        self.umanage = Button(master, text='User Management', font=('Lato', 18), borderwidth=0,background='#c92d22', fg='#fff', height=1, width=20)
        self.umanage.place(x= 170, y = 180)

        self.breports = Button(master, text='Business Reports', font=('Lato', 18), borderwidth=0,background='#c92d22', fg='#fff', height=1, width=20)
        self.breports.place(x= 170, y = 240)
        self.spredict = Button(master, text='Stock Prediction', font=('Lato', 18), borderwidth=0, background='#c92d22', fg='#fff', height=1, width=20)
        self.spredict.place(x= 170, y = 300)
...
class bill_frame(Frame):
    def __init__(self,master=None):
        Frame.__init__(self,master)
        self.parent = master
        self.parent.title("Bill Calculation")
        self.parent.configure(background="#2d3339")
        self.centerWindow()
        ...
        self.bill_label=Label(master, text='Add Billing Information', font=('Lato',20), fg='#fff', background='#2d3339')
...
class transaction_frame(Frame):
    def __init__(self,master=None):
        ...
        self.type_label=Label(master, text="Sales/Purchase: ",  font=("Lato", 15), fg='#fff', background='#16776A', width=10)
